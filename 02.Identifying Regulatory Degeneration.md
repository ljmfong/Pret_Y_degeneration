...
We ran a modified scAlleleCount python script - see [modified_scAlleleCount_script_example.py](). The outputted matricies were then processed in R - see [R_commands_to_prep_matrices.R]().
