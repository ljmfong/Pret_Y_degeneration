...
After processing the matrices into count files (see example count file) of the matrices, we processed each tissue separately - see [prepping_scRNA_scripts](https://github.com/ljmfong/Pret_Y_degeneration/tree/main/Prepping_scRNA_scripts).
